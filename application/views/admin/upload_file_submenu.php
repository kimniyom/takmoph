        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#file_upload').uploadify({
                    ...
                    'uploader': '<?= site_url('upload_photo/file_upload_submenu/' . $sub_id) ?>', //เมื่อ submit แล้วให้ action ไปที่ไฟล์ไหน
            ...
            <div id="body">
                <center>
                    ...
                    <a href="javascript:history.back();" style="text-decoration:none;">
                        <div class="btn btn-default" style="width:200px;">กลับไปที่ menu</div></a>
                </center>
            </div>
            <p class="footer">&nbsp;</p>
        </div>
